...
class RTMReviewService:
    ...
    def __init__(self, client: RateLimitOpenAIClient, model: str, model_kwargs: dict = {}):
        self.graph = RTMReviewerRunnable(client, model, model_kwargs, checkpointer=MemorySaver())
